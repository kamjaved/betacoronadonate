                        ...
                        <div class="col-sm-4 mb-2">
                            <div class="card border border-danger">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"> <i className="fa fa-university"></i> Account No- {acc.accountNo}</p>
                                    <p class="card-text"><strong>IFSC-  </strong>{acc.ifsc}</p>
                                    <p class="card-text"><strong>BANK NAME- </strong>{acc.bankName}</p>
                                    <p class="card-text"><strong>BANK BRANCH- </strong>{acc.bankBranch}</p>
...
export default connect(
    mapStateToProps,
    { getAccPays, deleteAccPay, setCurrentAccPay }
)(ViewPayAcc);
