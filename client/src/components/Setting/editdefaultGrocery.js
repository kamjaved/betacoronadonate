...
const EditDefaultGrocery = ({
    ...
    useEffect(() => {
        ...
        setFormData({
            default_grocery: loading || !setting.default_grocery ? "" : setting.default_grocery._id,
                            ...
                            <div className="row justify-content-center animated fadeIn">
                                <div className="col-lg-7 col-md-10 align-item-center">
                                    <div className="bg-light">
                                        <div>
                                            <h3 className="gray text-center p-4 text-white"><Link to="/dashboard" className="text-white"><i className="fa fa-arrow-left mr-2 float-left"></i></Link> Edit Default Grocery</h3></div>
                                        <fieldset className="p-4">
                                            ...
                                            <button type="submit" className="d-block py-3 px-5 gray border-0 rounded font-weight-bold mt-3 text-white">Edit</button>
...
export default connect(mapStateToProps, { editSetting, getCurrentSetting, })(EditDefaultGrocery);
