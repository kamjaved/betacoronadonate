...
export const getCurrentGrocery = id => async dispatch => {
    try {
        const res = await axios.get(`/api/grocery/${id}`);
...
export const getAllGrocerys = () => async dispatch => {
    try {
        const res = await axios.get("/api/grocery/getAll");
        console.log(res.data.data);
        dispatch({
...
export const getTotalGrocerys = () => async dispatch => {
    try {
        const res = await axios.get("/api/grocery/total");
        console.log(res.data.data);
        dispatch({
...
export const addGrocery = (formData, history) => async dispatch => {
    try {
        const res = await axios.post("/api/grocery", formData);
        dispatch({
...
export const editGrocery = (formData, history, id) => async dispatch => {
    try {
        const res = await axios.patch(`/api/grocery/${id}`, formData);
